...
import com.anonymity.util.TestDataGenerator;
...
public class ArxTest {
    ...
    @Test
    public void testBasicArxFunctionality() {
        try {
            // 匿名化參數設定
            ...
            // 產生測試資料
            List<Map<String, String>> data = TestDataGenerator.generateTestData(TEST_DATA_SIZE);
